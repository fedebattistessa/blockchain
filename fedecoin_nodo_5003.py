...
class Blockchain:
        ...
        def add_ransaction(self, sender, receiver, amount):
...
def mine_block():
    ...
    previous_hash = blockchain(previous_block)
    blockchain.add_transaction(sender = node_address, receiver = 'el', amount=1)
...
def connect_node():
    ...
    response = {'message':'Todos los nodos estan ahora conectados. El fedecoin blockchain contiene los siguientes nodos:',
